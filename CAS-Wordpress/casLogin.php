...
if ( !extension_loaded("curl") || !extension_loaded("ldap")) {
	 ...
	 * Plugin Includes
	*/
	include_once(plugin_dir_path(__FILE__). 'CAS.php');
	include_once(plugin_dir_path(__FILE__). 'casAuthenticate.php');
	include_once(plugin_dir_path(__FILE__). 'optionsMenu.php');
 ...
 */
function enqueueCSS()	{
	wp_enqueue_style('messages',plugins_url('messages.css', __FILE__));
}
?>